...
class Authenticator
{
	...
	/**
     * @var string
	 * path the cookie can be accessed from.
     */
    ...
    public function login()
    {
        ...
        switch ($this->storage->findTriplet($cookieValues[0], $cookieValues[1] . $this->salt, $cookieValues[2] . $this->salt)) {
            ...
            case Storage\StorageInterface::TRIPLET_FOUND:
                ...
                $this->cookie->setCookie($this->cookieName, implode("|", array($cookieValues[0], $newToken, $cookieValues[2])), $expire, $this->cookiePath, $this->cookieDomain, $this->cookieSecure);
    ...
    public function createCookie($credential)
    {
        ...
        $this->cookie->setCookie($this->cookieName, implode("|", array($credential, $newToken, $newPersistentToken)), $expire, $this->cookiePath, $this->cookieDomain, $this->cookieSecure);
